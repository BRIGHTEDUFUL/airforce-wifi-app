      ...
      <div className="flex-1 flex flex-col min-w-0 bg-slate-50 dark:bg-command-dark-bg">
        <header className="h-24 border-b border-slate-100 dark:border-command-dark-border flex items-center px-8 gap-6 bg-white dark:bg-command-dark-card">
          ...
          <div className="flex items-center gap-3">
            <button className="p-3 bg-slate-50 dark:bg-slate-900/50 hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl text-slate-400 dark:text-slate-500 transition-all border border-slate-100 dark:border-transparent">
              <Clock size={18} />
            </button>
            <button className="p-3 bg-slate-50 dark:bg-slate-900/50 hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl text-slate-400 dark:text-slate-500 transition-all border border-slate-100 dark:border-transparent">
              <Star size={18} />
