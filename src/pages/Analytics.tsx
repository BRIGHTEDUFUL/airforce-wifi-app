...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 space-y-6 md:space-y-8 bg-theme min-h-full animate-in fade-in duration-700">
      <header>
        <h1 className="text-2xl md:text-3xl font-bold text-theme tracking-tight">System Analytics</h1>
        <p className="text-theme-2 font-medium text-sm">Detailed metrics and data distribution across all modules.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                <Legend 
                  ...
                  height={36} 
                  iconType="circle" 
                  formatter={(value) => <span className="text-xs font-bold text-theme-2">{value}</span>}
                />
              </PieChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="bg-surface p-5 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-theme shadow-sm">
          ...
          <div className="space-y-6">
            ...
            {stats.topUsers.length === 0 && <p className="text-theme-3 text-sm italic font-medium">No user activity recorded yet.</p>}
          </div>
        </div>
