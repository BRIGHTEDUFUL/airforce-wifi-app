                ...
                <tr key={u.id} className="text-sm hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all group">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        {u.id === currentUser?.id && (
                          <span className="text-[10px] font-black text-command-blue uppercase tracking-widest mt-0.5">Current Session</span>
                        )}
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-8 py-6 text-right">
                    <button 
                      ...
                      className="p-3 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-2xl text-slate-400 dark:text-slate-500 hover:text-rose-500 dark:hover:text-rose-400 transition-all disabled:opacity-20 disabled:cursor-not-allowed group-hover:scale-110"
                    >
                      <Trash2 size={20} />
                    </button>
                  </td>
            ...
            <div className="p-10 space-y-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option className="dark:bg-slate-900">Administrator</option>
                    <option className="dark:bg-slate-900">Operator</option>
                    <option className="dark:bg-slate-900">Viewer</option>
                  </select>
                </div>
